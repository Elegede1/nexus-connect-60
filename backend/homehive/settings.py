...
ASGI_APPLICATION = 'homehive.asgi.application'
...
# Media files (Uploaded files - will be stored in Supabase)
MEDIA_URL = 'media/'
...
# Social Auth Providers (Optional - configure when ready)
...
# Custom Adapters for role selection
