  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]",
        "hero-outline": "border-2 border-primary/20 bg-card/80 backdrop-blur-sm text-foreground hover:border-primary hover:bg-card shadow-md hover:shadow-lg hover:-translate-y-0.5",
        emerald: "gradient-secondary text-white shadow-lg hover:shadow-xl hover:-translate-y-1 hover:scale-[1.02]",
      },
      size: {
